...
var viewModel = function () {
	...
	this.goTo = function(navItem) {
		...
		var navItemLoc = {
			"About" : [about.offset().left, about.offset().top - 100],
			"Referrals" : [referrals.offset().left, referrals.offset().top],
			"Contact" : [contact.offset().left, contact.offset().top],
			"Booking" : [booking.offset().left, booking.offset().top]
		}
